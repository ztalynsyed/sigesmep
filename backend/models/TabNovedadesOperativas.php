...
class TabNovedadesOperativas extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['DISTRITO', 'CANTON', 'usuario_actualizacion','observacion_actualizacion','usuario_ingreso'], 'string', 'max' => 250],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'JEFES_CONTROL' => 'Jefes de Control',
            ...
            'RADIOS_COMUNICACION' => 'Radios de Comunicacion',
